...
断面剛性$EA$は全断面で一定とする．
\paragraph{解答:}
問題で与えら得れた系の曲げモーメントは，図\ref{f:g:}に示した座標$s$により
\begin{equation}
	M(s)=-\frac{q_0s^2}{2}
	\label{eqn:}
\end{equation}
...
\begin{eqnarray}
	...
	\label{eqn:}
\end{eqnarray}
となることが示される．この結果において$b=l/2$および$b=l$とすれば
\begin{equation}
	\int_0^l M(s)\tilde M(s) ds =
	\left\{
	\begin{array}{cc}
		\frac{1}{8}q_0l^4& (b=l)  \\
		\frac{7}{192}q_0l^4& (b=l/2)  
	\end{array}
	\right.
	\label{eqn:}
\end{equation}
が得られる．以上を式()に代入すれば、求めるべきたわみが次の通りとなることが分かる．
\begin{equation}
	u_B= \frac{7}{192}\frac{q_0l^4}{EI}
	, \ \ 
